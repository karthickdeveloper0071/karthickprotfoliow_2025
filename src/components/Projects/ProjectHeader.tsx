...
const ProjectHeader: React.FC = () => {
    return (
        ...
        >
            ...
            >
                Hey, I’m Karthick 👋 A Fullstack engineer who loves building tools that solve real-world problems. I believe code isn't just logic — it’s storytelling, and every project I build tells a story of purpose, precision, and passion.
            </motion.p>
